...
function SignUpComponent(){
    ...
    const navigate = useNavigate();
     ...
     const handleSubmit = async (e)=>{
          e.preventDefault();
          try{
              var response = await axios.post("https://servicebikebackend.herokuapp.com/register/signup",{username:username , email:email , name:name , phone:phone , password:password})
