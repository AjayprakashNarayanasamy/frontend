...
function ProductComponent() {
  ...
  useEffect(async () => {
    ...
    var response = await axios.get("https://servicebikebackend.herokuapp.com/product/get", {
      headers:
      {
        "access-token": token
      }
  ...
  const updateProduct = async (id, userQuantity) => {
    const token = localStorage.getItem("token")
    var response = await axios.put(`https://servicebikebackend.herokuapp.com/product/update/${id}`, {
